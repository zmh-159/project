...
public class HighLoadModel extends General {
...
//        res.put("cpu_idle", 100 - cpuUser - cpuSystem);
        ...
        for (int i = 0; i < cpu_nums; ++i) {
            ...
            double temperature = getStable(65);
        ...
        for (int i = 0; i < network_nums; ++i) {
            ...
            network.put("up_speed", getStable(2048));
    ...
    public double getRandom(double max) {
        return getDoubleWith2(Math.round(Math.random() * max));
    }
